<?php $wp_url = "https://thelasallian.com/wp-json/wp/v2/posts?_fields=title,link,jetpack_featured_media_url,date,authors&tags=2107"; ?>
...
<body>
    ...
    <?php
        $most_recent_article = fetch_info('https://thelasallian.com/wp-json/wp/v2/posts?_fields=jetpack_featured_media_url&tags=2107&per_page=1&page=1');
        $sh_bgimg = $most_recent_article[0]["jetpack_featured_media_url"];
        $sh_gradientclass = 'sh-music';
        $sh_heading = 'Music';
        $sh_iconpath = 'assets/music.png';
    ?>
